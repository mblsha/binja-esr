...
class TestAPIIntegration(unittest.TestCase):
    ...
    def test_control_step(self):
        ...
        # Step
        response = self.client.post(
            "/api/v1/control", json={"command": "step"}, content_type="application/json"
        )
    ...
    def test_control_run_pause(self):
        ...
        # Start running
        response = self.client.post(
            "/api/v1/control", json={"command": "run"}, content_type="application/json"
        )
    ...
    def test_control_missing_command(self):
        ...
        response = self.client.post(
            "/api/v1/control", json={}, content_type="application/json"
        )
    ...
    def test_key_release(self):
        ...
        # First press a key
        self.client.post("/api/v1/key", json={"key_code": "KEY_B", "action": "press"})
    ...
    def test_key_default_action(self):
        ...
        response = self.client.post(
            "/api/v1/key", json={"key_code": "KEY_C"}, content_type="application/json"
        )
    ...
    def test_key_missing_key_code(self):
        ...
        response = self.client.post(
            "/api/v1/key", json={"action": "press"}, content_type="application/json"
        )
