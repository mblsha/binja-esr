...
class BinaryView(object):
    ...
    def get_function_at(self, addr: int) -> Optional[Any]: ...
    def create_user_function(self, addr: int) -> Optional[Any]: ...
    def __init__(self, parent_view: Optional["BinaryView"] = None, file_metadata: Any = None) -> None: ...
