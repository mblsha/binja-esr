...
from .simple_memory import SimplifiedMemory
from .display.simple_hd61202 import HD61202Controller

from .trace_manager import g_tracer


class TrackedMemory(SimplifiedMemory):
    ...
    def read_bytes(self, address: int, size: int) -> bytes:
        """Read multiple bytes and increment counter."""
...
class SimplifiedPCE500Emulator:
    """Simplified PC-E500 emulator with merged machine configuration.
    
    Combines PCE500Machine and PCE500Emulator into a single class,
    removes the PCE500Memory wrapper, and simplifies the overall structure.
    """
