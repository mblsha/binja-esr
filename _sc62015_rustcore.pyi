...
class Runtime:
    def __init__(self, memory: Any, *, reset_on_init: bool = True) -> None: ...
    def power_on_reset(self) -> None: ...
    def load_external_memory(self, snapshot: bytes) -> None: ...
    def set_python_ranges(self, ranges: Iterable[Tuple[int, int]]) -> None: ...
    def drain_external_writes(self) -> list[Tuple[int, int]]: ...
