...
def test_iq7000_full_view_maps_complete_external_space_without_gaps() -> None:
    ...
    assert [
        ...
        (0x46649, 0x49E41, 0x46649),
        (0x49E41, 0x4A000, 0x49E41),
        (0x4A000, 0x4EC08, 0x4A000),
        (0x4EC08, 0x50000, 0x4EC08),
        (0x50000, 0x50046, 0x50000),
        ...
        (0x596FB, 0x5FCB3, 0x596FB),
        (0x5FCB3, 0x5FFD9, 0x5FCB3),
        (0x5FFD9, 0x5FFE0, 0x5FFD9),
        (0x5FFE0, 0x5FFEC, 0x5FFE0),
        (0x5FFEC, 0x5FFF0, 0x5FFEC),
        (0x5FFF0, 0x5FFF8, 0x5FFF0),
        (0x5FFF8, 0x60000, 0x5FFF8),
        (0x60000, 0x80000, 0x60000),
        (0x80000, 0xA0000, 0x80000),
        (0xA0000, 0xC0000, 0xA0000),
        (0xC0000, 0xE0000, 0xC0000),
        (0xE0000, 0xEBA78, 0xE0000),
        (0xEBA78, 0xEBA84, 0xEBA78),
        (0xEBA84, 0xEEC87, 0xEBA84),
        ...
        (0xEED25, 0xEFFB0, 0xEED25),
        (0xEFFB0, 0xF0000, 0xEFFB0),
        (0xF0000, 0xF03F5, 0xF0000),
        ...
        (0xF3969, 0xF3A68, 0xF3969),
        (0xF3A68, 0xF3A7D, 0xF3A68),
        (0xF3A7D, 0xF3C19, 0xF3A7D),
        (0xF3C19, 0xF4019, 0xF3C19),
        (0xF4019, 0xF4081, 0xF4019),
        (0xF4081, 0xF4095, 0xF4081),
        (0xF4095, 0xF5CA8, 0xF4095),
        (0xF5CA8, 0xF5CAC, 0xF5CA8),
        (0xF5CAC, 0xF7C73, 0xF5CAC),
        ...
        (0xFDAA0, 0xFE52B, 0xFDAA0),
        (0xFE52B, 0xFFFDC, 0xFE52B),
        (0xFFFDC, 0xFFFE0, 0xFFFDC),
...
def test_model_specific_public_entry_points_are_seeded() -> None:
    ...
    assert (
        0xE99D2,
        "iocs_header_entry_cas_e99d2",
    ) in SC62015FullView.EXTRA_ENTRY_POINTS
    assert (
        0xEAD5B,
        "iocs_header_entry_com_ead5b",
    ) in SC62015FullView.EXTRA_ENTRY_POINTS
    for entry in (
    ...
    for entry in (
        ...
        (
            0xFBD4B,
            "pacom_panet_recv_frame_checksum_ack_check_first_fbd4b",
        ),
...
def test_iq7000_proven_inline_data_ranges_are_exact() -> None:
    ...
    expected = {
        ...
        "HOME title label": (0xEBA78, 0xEBA84),
        ...
        "Keyboard fallback callback records": (0xF3A68, 0xF3A7D),
        ...
        "dev0E command dispatch table": (0xF5CA8, 0xF5CAC),
        ...
        "Lower ROM operand and FF padding": (0x49E41, 0x4A000),
        "Embedded RAMFILE BASIC filesystem": (0x4A000, 0x4EC08),
        "Lower ROM FF padding 4EC08": (0x4EC08, 0x50000),
        "Lower ROM FF padding 5FCB3": (0x5FCB3, 0x5FFD9),
        "Lower ROM vector-tail metadata before JPF stubs": (0x5FFD9, 0x5FFE0),
        "Lower ROM vector-tail FF separator": (0x5FFEC, 0x5FFF0),
        "Lower ROM vector-tail metadata": (0x5FFF8, 0x60000),
        "System ROM FF padding EFFB0": (0xEFFB0, 0xF0000),
        "System ROM FF padding FE52B": (0xFE52B, 0xFFFDC),
    }
    assert {
        name: (segments[name].start, segments[name].start + segments[name].length)
