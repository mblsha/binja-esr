...
class Decoder:
    ...
    def unsigned_word_le(self):
        return self._unpack("H")

    def unsigned_word_be(self):
        return self._unpack(">H")

    def signed_word_le(self):
        return self._unpack("h")

    def signed_word_be(self):
        return self._unpack(">h")
...
class Encoder:
    ...
    def unsigned_word_le(self, value):
        self._pack("H", value)

    def unsigned_word_be(self, value):
        self._pack(">H", value)

    def signed_word_le(self, value):
        self._pack("h", value)

    def signed_word_be(self, value):
        self._pack(">h", value)
