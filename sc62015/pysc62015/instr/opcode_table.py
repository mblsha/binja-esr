...
OPCODES = {
    ...
    0x03: (JP_Abs, Opts(name="JPF", ops=[FarControlImm20()])),
    0x04: (CALL, Opts(ops=[Imm16()])),
    0x05: (CALL, Opts(name="CALLF", ops=[FarControlImm20()])),
    0x06: RET,
    0x07: RETF,
    0x08: (MV, Opts(ops=[Reg("A"), Imm8()])),
    0x09: (MV, Opts(ops=[RegIL(), Imm8()])),
    0x0A: (MV, Opts(ops=[Reg("BA"), Imm16()])),
    0x0B: (MV, Opts(ops=[Reg("I"), Imm16()])),
    0x0C: (MV, Opts(ops=[Reg("X"), RegisterImm20()])),
    0x0D: (MV, Opts(ops=[Reg("Y"), RegisterImm20()])),
    0x0E: (MV, Opts(ops=[Reg("U"), RegisterImm20()])),
    0x0F: (MV, Opts(ops=[Reg("S"), RegisterImm20()])),
    # 10h
    ...
    0x72: (AND, Opts(ops=[AbsoluteByteOpAddr(width=1), Imm8()])),
    ...
    0x7A: (OR, Opts(ops=[AbsoluteByteOpAddr(width=1), Imm8()])),
    ...
    0x88: (MV, Opts(ops=[Reg("A"), DirectReadAbsoluteAddr(width=1)])),
    0x89: (MV, Opts(ops=[RegIL(), DirectReadAbsoluteAddr(width=1)])),
    0x8A: (MV, Opts(ops=[Reg("BA"), DirectReadAbsoluteAddr(width=2)])),
    0x8B: (MV, Opts(ops=[Reg("I"), DirectReadAbsoluteAddr(width=2)])),
    0x8C: (MV, Opts(ops=[Reg("X"), DirectReadAbsoluteAddr(width=3)])),
    0x8D: (MV, Opts(ops=[Reg("Y"), DirectReadAbsoluteAddr(width=3)])),
    0x8E: (MV, Opts(ops=[Reg("U"), DirectReadAbsoluteAddr(width=3)])),
    0x8F: (MV, Opts(ops=[Reg("S"), DirectReadAbsoluteAddr(width=3)])),
    # 90h
    0x90: (MV, Opts(ops=[Reg("A"), EMemReg(width=1)])),
    0x91: (MV, Opts(ops=[RegIL(), EMemReg(width=1)])),
    ...
    0x99: (MV, Opts(ops=[RegIL(), EMemIMem(width=1)])),
    ...
    0xA8: (MV, Opts(ops=[DirectWriteAbsoluteAddr(width=1), Reg("A")])),
    0xA9: (MV, Opts(ops=[DirectWriteAbsoluteAddr(width=1), RegIL()])),
    0xAA: (MV, Opts(ops=[DirectWriteAbsoluteAddr(width=2), Reg("BA")])),
    0xAB: (MV, Opts(ops=[DirectWriteAbsoluteAddr(width=2), Reg("I")])),
    0xAC: (MV, Opts(ops=[DirectWriteAbsoluteAddr(width=3), Reg("X")])),
    0xAD: (MV, Opts(ops=[DirectWriteAbsoluteAddr(width=3), Reg("Y")])),
    0xAE: (MV, Opts(ops=[DirectWriteAbsoluteAddr(width=3), Reg("U")])),
    0xAF: (MV, Opts(ops=[DirectWriteAbsoluteAddr(width=3), Reg("S")])),
    # B0h
    0xB0: (MV, Opts(ops=[EMemReg(width=1), Reg("A")])),
    0xB1: (MV, Opts(ops=[EMemReg(width=1), RegIL()])),
    ...
    0xB9: (MV, Opts(ops=[EMemIMem(width=1), RegIL()])),
    ...
    # D0h
    0xD0: (MV, Opts(ops=[IMem8(), AbsoluteTransferAddr(width=1)])),
    0xD1: (MV, Opts(name="MVW", ops=[IMem16(), AbsoluteTransferAddr(width=2)])),
    0xD2: (MV, Opts(name="MVP", ops=[IMem20(), AbsoluteTransferAddr(width=3)])),
    0xD3: (MVL, Opts(ops=[IMem8(), AbsoluteTransferAddr(width=1)])),
    ...
    0xD8: (MV, Opts(ops=[AbsoluteTransferAddr(width=1), IMem8()])),
    0xD9: (MV, Opts(name="MVW", ops=[AbsoluteTransferAddr(width=2), IMem16()])),
    0xDA: (MV, Opts(name="MVP", ops=[AbsoluteTransferAddr(width=3), IMem20()])),
    0xDB: (MVL, Opts(ops=[AbsoluteTransferAddr(width=1), IMem8()])),
