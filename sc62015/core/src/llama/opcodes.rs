...
/// TODO: transcribe entries from Python opcode_table.py.
pub static OPCODES: &[OpcodeEntry] = &[
    ...
    OpcodeEntry {
        ...
        ops_reversed: None,
        operands: &[
            OperandKind::EMemAddrWidth(3),
            OperandKind::Reg(RegName::A, 8),
        ],
    },
    OpcodeEntry {
        opcode: 0xA9,
        ...
        cond: None,
        ops_reversed: None,
        operands: &[OperandKind::EMemAddrWidth(3), OperandKind::RegIL],
    },
    OpcodeEntry {
        opcode: 0xAA,
        kind: InstrKind::Mv,
    ...
    OpcodeEntry {
        ...
        operands: &[
            OperandKind::EMemAddrWidth(3),
            OperandKind::Reg(RegName::S, 24),
        ],
    },
    // B0h block (MV reg -> EMEM reg/IMEM combos)
    OpcodeEntry {
        opcode: 0xB0,
        kind: InstrKind::Mv,
        name: "MV",
    ...
    // 40h arithmetic/memory block (partial)
    OpcodeEntry {
        opcode: 0x40,
        kind: InstrKind::Add,
        name: "ADD",
    ...
    // 50h block (ADC/SBC/MVL/PMDF variants)
    OpcodeEntry {
        opcode: 0x50,
        kind: InstrKind::Adc,
        name: "ADC",
    ...
    // 60h compare/test/xor/inc/dec block (partial)
    OpcodeEntry {
        opcode: 0x60,
        kind: InstrKind::Cmp,
        name: "CMP",
    ...
    OpcodeEntry {
        ...
        cond: None,
        ops_reversed: None,
        operands: &[OperandKind::EMemAddrWidth(3), OperandKind::Imm(8)],
    },
    OpcodeEntry {
        opcode: 0x63,
        kind: InstrKind::Cmp,
    ...
    // 70h block (AND/OR, reg moves, dec)
    OpcodeEntry {
        opcode: 0x70,
        kind: InstrKind::And,
        name: "AND",
    ...
    // 80h block (MV from IMEM/EMEM to regs)
    OpcodeEntry {
        opcode: 0x80,
        kind: InstrKind::Mv,
        name: "MV",
    ...
    // 88h block (MV from EMEM addr to regs)
    OpcodeEntry {
        opcode: 0x88,
        kind: InstrKind::Mv,
        name: "MV",
    ...
    OpcodeEntry {
        ...
        cond: None,
        ops_reversed: None,
        operands: &[OperandKind::RegIL, OperandKind::EMemAddrWidth(3)],
    },
    OpcodeEntry {
        opcode: 0x8A,
        kind: InstrKind::Mv,
    ...
    // 90h block (MV from EMEM reg/pointer to regs) and SC/RC
    OpcodeEntry {
        opcode: 0x90,
        kind: InstrKind::Mv,
        name: "MV",
    ...
    OpcodeEntry {
        ...
        cond: None,
        ops_reversed: None,
        operands: &[OperandKind::IMem(8), OperandKind::EMemAddrWidth(3)],
    },
    OpcodeEntry {
        opcode: 0xD1,
        kind: InstrKind::Mvw,
        ...
        cond: None,
        ops_reversed: None,
        operands: &[OperandKind::IMem(16), OperandKind::EMemAddrWidth(3)],
    },
    OpcodeEntry {
        opcode: 0xD2,
        kind: InstrKind::Mvp,
    ...
    OpcodeEntry {
        ...
        cond: None,
        ops_reversed: None,
        operands: &[OperandKind::EMemAddrWidth(3), OperandKind::IMem(8)],
    },
    OpcodeEntry {
        opcode: 0xD9,
        kind: InstrKind::Mvw,
        ...
        cond: None,
        ops_reversed: None,
        operands: &[OperandKind::EMemAddrWidth(3), OperandKind::IMem(16)],
    },
    OpcodeEntry {
        opcode: 0xDA,
        kind: InstrKind::Mvp,
    ...
    OpcodeEntry {
        ...
        cond: None,
        ops_reversed: None,
        operands: &[OperandKind::EMemRegModePostPre, OperandKind::IMem(8)],
    },
    OpcodeEntry {
        opcode: 0xEC,
        kind: InstrKind::Dsll,
